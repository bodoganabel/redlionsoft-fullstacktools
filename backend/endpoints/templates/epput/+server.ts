...
//+server.ts
export const PUT = EndpointGenerator.RLS_BODY_ENDPOINT(SNamexxx_PUT_Body, SNamexxx_PUT_Response, { requireAuthentication: true, requirePermissions: [], responseHeaders: { "Content-Type": "application/json" } }, async ({ params, body, user, request, url }) => {
